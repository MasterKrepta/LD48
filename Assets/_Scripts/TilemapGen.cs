...
public class TilemapGen : MonoBehaviour
{
    ...
    void GenerateMap()
    {
        ...
        mapArray = GenerateArray(mapWidth, mapHeight, true);
        RenderMap(PerlinNoiseSmooth(mapArray, seed, 3), myTileMap, tile);
        //StartCoroutine("RenderMap(PerlinNoiseSmooth(mapArray, seed, 3), myTileMap, tile)");
        //StartCoroutine(RenderMap(PerlinNoise(mapArray, seed)), tileMap, tile);
